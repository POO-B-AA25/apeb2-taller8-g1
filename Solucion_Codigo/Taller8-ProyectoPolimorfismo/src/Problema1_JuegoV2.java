...
public class Problema1_JuegoV2 {
            ...
            if (continuarPersonajes.equals("S")) {
                ...
                switch (tipoPersonaje) {
                    case 1 -> {
                        ...
                        Guerrero guerrero = new Guerrero(fuerza, habilidades, estrategias, atributos, puntosVida, nombre, apellido);
                    ...
                    case 2 -> {
                        ...
                        Mago mago = new Mago(poder, habilidades, estrategias, atributos, puntosVida, nombre, apellido);
                    ...
                    case 3 -> {
                        ...
                        Arquero arquero = new Arquero(presicion, habilidades, estrategias, atributos, puntosVida,  nombre, apellido);
...
abstract class Personaje {
    ...
    public Personaje(int habilidades, int estrategias, int atributos, int puntosVida, String nombre, String apellidos) {
...
class Guerrero extends Personaje {
    ...
    public Guerrero(int fuerza, int habilidades, int estrategias, int atributos,int puntosVida, String nombre, String apellidos){
        super(habilidades, estrategias, atributos, puntosVida, nombre, apellidos);
        this.fuerza = fuerza;
    }
    ...
    @Override
    public String toString() {
        return "Guerrero{fuerza=" + fuerza + ", fuerzaTotal=" + fuerzaTotal + ", defensaTotal=" + defensaTotal + ", resistenciaTotal=" + resistenciaTotal + "} " + super.toString();
    }
}
...
class Mago extends Personaje {
    ...
    public Mago(int poder, int habilidades, int estrategias, int atributos, int puntosVida, String nombre, String apellidos) {
        super(habilidades, estrategias, atributos, puntosVida, nombre, apellidos);
        this.poder = poder;
    }
    ...
    @Override
    public String toString() {
        return "Mago{poder=" + poder + ", poderMagico=" + poderMagico + ", inteligencia=" + inteligencia + ", manaTotal=" + manaTotal + "} " + super.toString();
    }
}
...
class Arquero extends Personaje {
    ...
    public Arquero(int presicion, int habilidades, int estrategias, int atributos, int puntosVida, String nombre, String apellidos) {
        super(habilidades, estrategias, atributos, puntosVida, nombre, apellidos);
    ...
    @Override
    public String toString() {
        return "Arquero{presicion=" + presicion + ", punteria=" + punteria + ", agilidad=" + agilidad + ", alcance=" + alcance + "} " + super.toString();
    }
}
